...
export const mapSortKeys = (sort: string | undefined, type: 'collection' | 'product') => {
  switch (sort) {
    case 'price-asc': return { sortKey: 'price-asc', reverse: false };
    case 'price-desc': return { sortKey: 'price-desc', reverse: true };
